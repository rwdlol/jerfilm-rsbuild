...
export const AdultBlockedNotice: React.FC<AdultBlockedNoticeProps> = ({
	onRouteChange,
}) => {
	return (
		<div className="min-h-[80vh] flex items-center justify-center px-4 py-16">
			<div className="max-w-md w-full bg-zinc-900/90 border border-zinc-800 rounded-3xl p-8 text-center backdrop-blur-xl shadow-2xl animate-in zoom-in-95 duration-300 relative overflow-hidden">
				...
				<p className="text-xs sm:text-sm text-zinc-400 leading-relaxed mb-8">
					بەپێی یاساکانی جێر فیلم (Jerfilm.VIP)، بڵاوکردنەوە و نیشاندانی بەرهەم
					و فیلم و زنجیرەی تایبەت بە گەورەساڵان (+18) بە هەموو شێوەیەک قەدەغەیە.
				</p>

				<button
					type="button"
					onClick={() => onRouteChange({ mode: "home" })}
					className="w-full py-3.5 px-6 rounded-xl bg-linear-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-zinc-950 font-black text-sm flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 transition-all hover:scale-[1.02] active:scale-95"
				>
