...
export const MediaCard: React.FC<MediaCardProps> = ({
	...
	return (
		...
		>
			...
			<div
				className={`relative w-full overflow-hidden bg-zinc-950 ${aspectRatio === "poster" ? "aspect-2/3" : "aspect-video"}`}
			>
				<img
					src={imageUrl}
					alt={title}
				...
				{/* Gradient Overlay */}
				<div className="absolute inset-0 bg-linear-to-t from-zinc-950 via-zinc-950/20 to-transparent opacity-80 group-hover:opacity-60 transition-opacity" />
