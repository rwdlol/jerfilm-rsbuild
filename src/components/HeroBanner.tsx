...
export const HeroBanner: React.FC<HeroBannerProps> = ({
	...
	return (
		<div className="relative w-full h-[65vh] min-h-105 max-h-150 overflow-hidden bg-zinc-950">
			...
			<div className="absolute inset-0">
				...
				<div className="absolute inset-0 bg-linear-to-l from-zinc-950 via-zinc-950/80 to-transparent w-full md:w-3/4" />
			</div>
				...
				<div className="max-w-2xl space-y-3 text-right">
					...
					<p className="text-xs sm:text-sm text-zinc-300 font-normal line-clamp-2 sm:line-clamp-3 leading-relaxed max-w-xl drop-shadow">
						{currentMedia.overview ||
							"هیچ کورتەیەک بەردەست نییە بۆ ئەم بەرهەمە."}
					</p>
