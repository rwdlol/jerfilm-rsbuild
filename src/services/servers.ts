...
export const STREAM_SERVERS: StreamServer[] = [
  {
    ...
    getMovieUrl: (tmdbId: number) => `https://vaplayer.ru/embed/movie/${tmdbId}?color=ffd700`,
  ...
  },
  {
    ...
    getMovieUrl: (tmdbId: number) => `https://vsembed.ru/embed/movie?tmdb=${tmdbId}`,
    getTvUrl: (tmdbId: number, season: number, episode: number) => 
  ...
  },
  {
    ...
    getMovieUrl: (tmdbId: number) => `https://player.videasy.net/movie/${tmdbId}?color=ffd700&overlay=true`,
    getTvUrl: (tmdbId: number, season: number, episode: number) => 
  ...
  },
  {
    ...
    getMovieUrl: (tmdbId: number) => `https://vidlink.pro/movie/${tmdbId}?primaryColor=ffd700&secondaryColor=0028ff`,
    getTvUrl: (tmdbId: number, season: number, episode: number) => 
  ...
  },
  {
    ...
    getMovieUrl: (tmdbId: number) => `https://embedmaster.link/j2wmgzaw0so4wj6m/movie/${tmdbId}`,
    getTvUrl: (tmdbId: number, season: number, episode: number) => 
