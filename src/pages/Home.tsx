        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-zinc-950 border border-zinc-900 rounded-3xl p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex flex-col gap-3 max-w-2xl">
              <span className="flex text-sm items-center gap-1 text-rose-500 bg-rose-500/10 w-fit px-3 py-1 rounded-full border border-rose-500/20">
            ...
            <a
              ...
              className="bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-white font-bold py-3 px-5 rounded-2xl transition-all duration-200 shrink-0 cursor-pointer"
            >
