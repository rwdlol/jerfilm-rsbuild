...
export default function PaMovieDetailViewge({
	movieId,
	onRouteChange,
	isInWatchlist,
	onToggleWatchlist,
		...
		return (
			<div className="min-h-screen pt-20 flex flex-col items-center justify-center gap-3">
				...
				<span className="text-xs font-semibold text-zinc-400">
					تکایە چاوەڕێ بکە... گواستنەوەی زانیارییەکانی فیلمەکە
				</span>
			</div>
		);
	}
	...
	return (
		<div className="pb-24">
			<SEO
				...
				description={
					movie.overview
						? tToSorani(movie.overview)
						: `سەیرکردنی فیلمی ${movie.title} بە ژێرنووسی کوردی و کوالێتی بەرز.`
				}
				...
				schemaData={{
					...
					description: movie.overview
						? tToSorani(movie.overview)
						: `فیلمی ${movie.title} بە ژێرنووسی کوردی`,
					image: posterUrl,
					...
					<div className="flex-1 space-y-4 text-center md:text-right">
						...
						<div className="flex items-center justify-center md:justify-start gap-3 pt-2 flex-wrap">
							<button
								type="button"
								onClick={() =>
									onRouteChange({ mode: "watch-movie", id: movie.id })
								}
