...
import { Tv, Globe, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const TVSeriesView: React.FC<TVSeriesViewProps> = ({
  onRouteChange,
  isInWatchlist,
  onToggleWatchlist,
}) => {
  ...
  return (
    <div className="pt-20 pb-24 max-w-7xl mx-auto px-4 sm:px-6">
      <SEO
        ...
        keywords={["زنجیرەکان", "زنجیرەی کوردی", "ژێرنووسی کوردی", "سەیرکردنی زنجیرە", "Jerfilm"]}
      />
      ...
      {loading ? (
        <div className="py-20 flex flex-col items-center justify-center gap-3">
          ...
          <span className="text-xs text-zinc-400 font-medium">تکایە چاوەڕێ بکە... زنجیرەکان بەدەست دەگەڕێن</span>
        </div>
      ) : shows.length === 0 ? (
