...
import { Film, Globe, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const MoviesView: React.FC<MoviesViewProps> = ({
  ...
  return (
    <div className="pt-20 pb-24 max-w-7xl mx-auto px-4 sm:px-6">
      <SEO
        title="فیلمەکان - سەیرکردنی نوێترین فیلمەکان بە ژێرنووسی کوردی"
        description="هەڵبژاردن و سەیرکردنی هەزاران فیلمی سینەمایی سەرکەوتووی جیهانی بە ژێرنووسی کوردی بە خۆڕایی."
        keywords={["فیلمەکان", "سەیرکردنی فیلم", "ژێرنووسی کوردی", "فیلمی ئاکشن", "فیلمی کۆمێدی", "Jerfilm"]}
      />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black text-white font-display flex items-center gap-2.5">
            ...
            <span>گەڕان لە فیلمەکاندا</span>
          </h1>
          <p className="text-xs text-zinc-400 mt-1">
            هەزاران فیلمی سینەمایی، پڕبینەر و بەناوبانگی جیهانی بپشکنە
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <div className="flex items-center gap-1.5 bg-zinc-900 border border-zinc-800 px-3 py-1.5 rounded-2xl">
            ...
            <span className="text-xs text-zinc-400 font-bold whitespace-nowrap">وڵات:</span>
            <select
      ...
      {loading ? (
        <div className="py-20 flex flex-col items-center justify-center gap-3">
          ...
          <span className="text-xs text-zinc-400 font-medium">تکایە چاوەڕێ بکە... فیلمەکان بەدەست دەگەڕێن</span>
        </div>
      ) : movies.length === 0 ? (
        <div className="py-20 text-center text-zinc-500 text-sm">
          هیچ فیلمێک بۆ ئەم ژانەرە یان پۆلێنە نەدۆزرایەوە.
        </div>
      ) : (
        <>
