...
import { getImageUrl, getPopularPersons } from "../services/tmdb";
import type { ActiveRoute, Person } from "../types";

interface ActorsViewProps {
	onRouteChange: (route: ActiveRoute) => void;
}

export default function ActorsView({ onRouteChange }: ActorsViewProps) {
					...
					{filteredActors.map((actor) => {
						...
						return (
							<div
								key={actor.id}
								onClick={() =>
									onRouteChange({ mode: "actor-detail", id: actor.id })
								}
